...
@fitter_create_router.get("", name="fitter-create:create-fitter-page")
...
@fitter_create_router.post("", name="fitter-create:create-fitter-page-form")
async def create_fitter_page_form(
    *,
    ...
    if active_fitter:
        ...
        fitter_create.password = auth_service.hash_password(
            password=fitter_create.password
        )
        try:
